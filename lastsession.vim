...
silent only
cd ~/Documents/ether/FirstEthereumExperiment
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +0 gulpfile.js
badd +0 src/compile_contract.js
badd +0 src/deploy_contract.js
argglobal
silent! argdel *
argadd gulpfile.js
set stal=2
...
9
normal! 034|
tabedit src/compile_contract.js
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
10
normal! 022|
tabedit src/deploy_contract.js
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 13 - ((4 * winheight(0) + 25) / 51)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
13
